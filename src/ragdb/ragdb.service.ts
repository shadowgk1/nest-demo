...
export class RagdbService {
    ...
    private pgVectorStoreConfig = {
        pool: this.pgPool, //连接池
        collectionName: 'rag-knowledge-base', //集合名称，类似于命名空间，用于区分不同业务的向量数据
        collectionTableName: 'langchain-pg-collection', //集合表名称，用于存储向量数据
        tableName:'langchain-pg-embedding',//向量表名
        columns:{
            id:'id',//文档id列
            vector:'embedding',//向量列
            content:'content',//文档内容
            metadata:'metadata'//源数据列，储存文档的额外信息，如来源，id等
        },
